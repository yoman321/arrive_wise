  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted">
        Where are you leaving from? Use your live location for a real, traffic-aware
        route — or pick a rough distance.
      </p>
      ...
      <button
        onClick={locateMe}
        disabled={busy != null}
        className="flex w-full items-center justify-center gap-2 rounded-xl border border-accent/50 bg-accent/10 px-4 py-3 text-sm font-semibold text-accent transition hover:bg-accent/15 disabled:opacity-50"
      >
        📍 {busy === "locate" ? "Locating…" : busy === "route" ? "Routing…" : "Use my live location"}
      </button>
